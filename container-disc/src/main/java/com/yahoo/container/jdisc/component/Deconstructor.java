...
public class Deconstructor implements ComponentDeconstructor {
    ...
    public void uninstallBundles() {
        executor.schedule(new UninstallObsoleteBundlesTask(), delay.getSeconds(), TimeUnit.SECONDS);
    }

    private class UninstallObsoleteBundlesTask implements Runnable {
    ...
    private class DestructComponentTask implements Runnable {
